...
# Hi there! 👋 I'm Fidelis Odhiambo

## 🚀 About Me

I’m a passionate software developer driven by the challenge of building systems that just *work*—seamlessly and efficiently. My expertise lies in crafting robust enterprise applications using technologies like **C#, .NET, and Blazor**.

Whether it's architecting complex API integrations, designing intuitive user interfaces, or optimizing database performance, I love turning intricate technical problems into clean, user-friendly solutions.

Coding isn't just a job for me; it's a continuous journey of learning and refining. I get a kick out of:
*   Mastering new design patterns
*   Debugging the "impossible"
*   Sharing knowledge with the community

I believe that good software should be **reliable, maintainable, and scalable**—principles I apply to every line of code I write.
...
*   **Frameworks:** .NET 8, Blazor (Server & WASM), ASP.NET Core
*   **Tools:** Visual Studio, Git, SQL Server, Docker
*   **Focus Areas:** Enterprise Architecture, API Integration, Real-time Systems

---

## ❤️ Why Support Me?

Your support fuels my ability to dive deeper into open-source projects, create educational content, and build tools that help other developers succeed. 

It buys me the time (and the coffee! ☕) to:
1.  Experiment with bleeding-edge features.
2.  Write comprehensive tutorials and guides.
3.  Refine the projects I share with the community.

Every contribution directly helps me create better resources and continue building software that makes a difference.
Tel: +254 746 906 860
